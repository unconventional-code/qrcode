...
test('PNG renderer interface', function (t) {
	...
	t.type(PngRenderer.renderToDataURL, 'function', 'Should have renderToDataURL function');

	t.type(PngRenderer.renderToFile, 'function', 'Should have renderToFile function');

	t.type(PngRenderer.renderToFileStream, 'function', 'Should have renderToFileStream function');
